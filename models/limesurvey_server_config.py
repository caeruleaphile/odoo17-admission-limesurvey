...
class LimeSurveyServerConfig(models.Model):
    ...
    api_url = fields.Char(
        ...
        required=True,
        tracking=True,
        help='Base URL of your LimeSurvey installation (e.g., http://localhost/limesurvey or https://surveys.example.com)',
        default='http://localhost/limesurvey',
    )
    username = fields.Char(
        string='Username',
        required=True,
        tracking=True,
        help='LimeSurvey admin username',
        default='admin',
    )
    password = fields.Char(
        ...
        required=True,
        tracking=True,
        help='LimeSurvey admin password',
        password=True,
    )
